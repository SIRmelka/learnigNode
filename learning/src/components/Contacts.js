        ...
        <div className='contacts'>
          {
            contacts.map((contact)=>{
              return(
                <Contact image={contact.image} username={contact.name} option={contact.field}/>
              )
            })
          }
